...
NSArray<NSDictionary *> *LGExperimentalItems(void) {
    return @[
        ...
        LGSectionSetting(@"", @""),
        LGSectionSetting(LGLocalized(@"prefs.section.keyboard.title"),
                         LGLocalized(@"prefs.section.keyboard.subtitle")),
        LGNavSetting(LGLocalized(@"prefs.section.keyboard.title"),
                     LGLocalized(@"prefs.section.keyboard.subtitle"),
                     @"openKeyboard"),
        LGSectionSetting(@"", @""),
